...
public class Exercicio2 {
    ...
    /*
        Um sistema bancário simula a validação do CPF de um cliente e, caso ele seja válido, busca o saldoConta de sua conta em outro serviço.
            1. O primeiro serviço valida o CPF e retorna um booleano (true ou false).
            2. Se o CPF for válido, o segundo serviço retorna o saldoConta disponível (ex.: 1250.75).
